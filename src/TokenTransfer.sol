...
import {IRouterClient} from "@chainlink/ccip/contracts/ccip/interfaces/IRouterClient.sol";
import {OwnerIsCreator} from "@chainlink/contracts-ccip/contracts/shared/access/OwnerIsCreator.sol";
import {Client} from "@chainlink/contracts-ccip/contracts/ccip/libraries/Client.sol";
...
contract TokenTransfer is CCIPReceiver, OwnerIsCreator {
        ...
        returns (bytes32 messageId)
    {
        ...
        // Emit an event with message details
        emit MessageSent(messageId, _destinationChainSelector, _receiver, _token, _amount, address(0), fees);
     ...
     * @dev This function retrieves the ID, token address, and token amount of the last received CCIP message.
